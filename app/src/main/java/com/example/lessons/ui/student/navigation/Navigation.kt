...
import com.example.lessons.ui.student.Calendar
import com.example.lessons.ui.student.Conversation
import com.example.lessons.ui.student.Dashboard
import com.example.lessons.ui.student.FindTeacher
import com.example.lessons.ui.student.ProfileSettings
import com.example.lessons.ui.student.TeacherProfile
import com.example.lessons.ui.student.UpdateBasicData
import com.example.lessons.ui.student.UpdatePassword
import com.example.lessons.ui.student.Conversations
import com.example.lessons.ui.student.LessonRequest
import com.example.lessons.ui.student.LessonsHistory
import com.example.lessons.ui.student.LessonsRequests
import com.example.lessons.ui.student.TeacherRatings
...
@RequiresApi(35)
@Composable
fun Navigation(navController: NavHostController, content: Context, panelViewModel: PanelViewModel) {
    NavHost(navController = navController, startDestination = Screen.Dashboard.route) {
        ...
        composable(route = Screen.BasicData.route) {
            ...
            UpdateBasicData(navController, viewModel)
        }
        ...
        composable(route = Screen.FindTeacher.route) {
            FindTeacher(navController)
        }
        composable(route = Screen.TeacherProfile.route) { backStackEntry ->
            val viewModel = TeacherProfileViewModel(
                AppModule.provideApi(content),
                backStackEntry.arguments?.getString("id")
            )

            TeacherProfile(navController, viewModel)
        }
        ...
        composable(route = Screen.LessonRequests.route) {
        ...
        composable(
            route = Screen.TeacherRatings.route,
            arguments = listOf(navArgument("id") { type = NavType.StringType })
        ) { backStackEntry ->
            TeacherRatings(navController)
        }
    }
}
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
            ...
            Column(
                ...
                Navigation(navController, content, viewModel)
            }
